...
<div class="setting">
    <div class="big-buildCon" >
        <div class="big-nav" id="m-setting">
            ...
            <dl>
                <dt>
                    <a href="#" @click.prevent="xOpen = !xOpen"><b class="unfold"></b><h3>{{activeLayer.type=='bar'?'X':'Y'}}轴</h3></a>
            ...
            <dl>
                <dt>
                    <a href="#" @click.prevent="yOpen = !yOpen"><b class="unfold"></b><h3>{{activeLayer.type=='bar'?'Y':'X'}}轴</h3></a>
            ...
            <dl>
                ...
                <dd :class="{ open: sOpen }">
                    <div v-for="(item,index) in chartMsg.extra.series" :class="{'g-series': index != chartMsg.extra.series.length-1}">
                       ...
                       <div class="big-rule-box m-setting">
                           <h3>柱状</h3>
                            <setting-color name="柱图颜色" v-model="item.color" @change="updateSeries()"></setting-color>
                             <setting-number name="柱图宽度" v-model="item.pointWidth" @change="updateSeries()"></setting-number>
                           <setting-number name="边框宽度" v-model="item.borderWidth" @change="updateSeries()"></setting-number>
                           <setting-color name="边框颜色" v-model="item.borderColor" @change="updateSeries()"></setting-color>
                       </div>
