    ...
    <div class="big-buildCon" id="con-detail-1">
      <div class="big-nav">
        ...
        <dl class="style-item">
          ...
          <div class="big-rule-box m-setting clearfloat">
            <div class="item">
              <input-number :prop="starAngle" @change="updateStartAngle"></input-number>
            </div>
          </div>
          <div class="big-rule-box m-setting clearfloat">
            <div class="item">
              <input-number :prop="endAngle" @change="updateEndAngle"></input-number>
            </div>
          </div>
  ...
  export default {
      ...
      data () {
          return {
              ...
              starAngle:{title: '开始角度', value: -90},
              endAngle:{title: '结束角度', value: 90},
      ...
      methods: {
          ...
          updateStartAngle (value) {
              this.stomach.value = value;
              this.chartMsg.plotOptions.pie.startAngle = value;
              this.message();
          },
          updateEndAngle (value) {
              this.endAngle.value = value;
              this.chartMsg.plotOptions.pie.endAngle = value;
              this.message();
          },
