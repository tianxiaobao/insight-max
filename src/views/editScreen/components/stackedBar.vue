...
<div class="setting">
    <div class="big-buildCon" >
        <div class="big-nav" id="m-setting">
            ...
            <dl>
                ...
                <dd :class="{ open: overallOpen }">
                    <div class="big-rule-box m-setting">
                        ...
                        <setting-number name="柱图宽度" v-model="chartMsg.plotOptions.series.pointWidth" @change="updateChart()"></setting-number>
                    </div>
                    <div class="big-rule-box m-setting">
                        <h3>边距</h3>
            ...
            <dl>
                <dt>
                    <a href="#" @click.prevent="yOpen = !yOpen"><b class="unfold"></b><h3>X轴</h3></a>
            ...
            <dl>
                <dt>
                    <a href="#" @click.prevent="xOpen = !xOpen"><b class="unfold"></b><h3>Y轴</h3></a>
