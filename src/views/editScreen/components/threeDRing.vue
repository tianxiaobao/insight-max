            ...
            <dl>
                ...
                <dd :class="{ open: overallOpen }">
                    <div class="big-rule-box m-setting">
                        ...
                        <setting-number name="空心度(%)" v-model="chartMsg.plotOptions.pie.innerSize" @change="updateInnerSize()"></setting-number>
                    </div>
                    <div class="big-rule-box m-setting">
                        <h3>边距</h3>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            // 更新空心度
            updateInnerSize () {
                this.chartMsg.series[0].innerSize = this.chartMsg.plotOptions.pie.innerSize + '%';
                this.updateChart();
            }
        }
    };
